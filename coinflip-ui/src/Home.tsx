...
const Home = () => {
  ...
  const [bet, setBet] = useState<number>(0.002);
...
// @ts-ignore 
 ...
 new web3.PublicKey(config.oracleState.authority)
      ...
      console.log(hm.signers)
      await sendTransactionWithRetryWithKeypair(connection,wallet,hm.instructions,hm.signers)// (hm.tx as Transaction, hm.signers)
  ...
  return (
      <>
        <main className="container">
          {wallet && <p className="pp">Balance: {(balance || 0).toLocaleString()} OG staccOverflows</p>}
