...
function createSetCollectionSizeInstruction(accounts, args) {
    const { collectionMetadata, collectionAuthority, collectionMint, collectionAuthorityRecord } = accounts;
